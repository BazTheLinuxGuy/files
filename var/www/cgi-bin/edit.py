...
<html lang="en">
  <head>
	...
	color: #e1f1f1;
	font-size:10pt;
	font-family: "Georgia","Verdana","Sriracha",cursive,sans-serif;
    }	
...
/*	width: 50% */
  ...
  <body>
    ...
    <select name="location" id="location">
      <option value="{loc}">{locations[loc]}</option>
    ...
    <p style="font-family: cursive; font-size: 12pt; color: purple;">
...
#        myfile.close()
        ...
        w('we got to the "else" in get_fileid()\n')
        n = q.index('=')
        w(f'{n = }')
        fileident = q[n+1:]
        w('fileident = }\n')
